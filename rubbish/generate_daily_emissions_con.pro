pro generate_daily_emissions_con
...
;VOC
;speciesarr=['C','C2H4','C2H4O','C2H5OH','C2H6','C2H6S','C3H6','C3H6O','C3H8','C4','C5H8','CH2O','CH3OH','CH4','DM','Higher_Alkanes','Higher_Alkenes','NMHC','TC','Terpenes','Toluene_lum']
;BC,OC,PM
...
NCDF_VARPUT,outid,vlatid,latitude_part
NCDF_VARPUT,outid,vlonid,longitude_part
NCDF_VARPUT,outid,veid,gfedhly_part
NCDF_CLOSE,outid
